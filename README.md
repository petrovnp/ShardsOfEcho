...
Все тексты песен и материалы вселенной являются авторскими произведениями и интеллектуальной собственностью автора. Копирование, распространение, переработка и любое иное использование без письменного разрешения автора запрещены.

---

# ОсколкиЭха · ShardsOfEcho (English)
...
© **Nikolay Petrov** (ShardsOfEcho), 2026. All rights reserved.

All lyrics and universe materials are original works and the intellectual property of the author. Copying, distribution, adaptation, or any other use without the author's written permission is prohibited.
